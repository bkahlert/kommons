...
import com.bkahlert.kommons_deprecated.text.ANSI.Text
import com.bkahlert.kommons_deprecated.text.ANSI.Text.Companion.ansi
import com.bkahlert.kommons_deprecated.text.UnicodeOld.Emojis
...
public object Semantics {
    ...
    public object Symbols {
        public val OK: String = Emojis.HEAVY_CHECK_MARK.textVariant.formattedAs.success
        public val Negative: String = "━".formattedAs.error
        public val Computation: String = Emojis.HOURGLASS_WITH_FLOWING_SAND.emojiVariant.formattedAs.progress
        public val Error: String = UnicodeOld.GREEK_SMALL_LETTER_KOPPA.toString().ansi.bold.formattedAs.error
        public val PointNext: String = Emojis.HEAVY_ROUND_TIPPED_RIGHTWARDS_ARROW.formattedAs.meta
        public val Document: String = Emojis.PAGE_FACING_UP.toString()
