...
import com.bkahlert.kommons_deprecated.text.ANSI.FilteringFormatter
import com.bkahlert.kommons_deprecated.text.ANSI.Formatter
import com.bkahlert.kommons_deprecated.text.ANSI.Text.ColoredText
import com.bkahlert.kommons_deprecated.text.ANSI.Text.Companion.ansi
import com.bkahlert.kommons_deprecated.text.AnsiCode.Companion.REGEX
import com.bkahlert.kommons_deprecated.text.AnsiCodeHelper.closingControlSequence
import com.bkahlert.kommons_deprecated.text.AnsiCodeHelper.controlSequence
import com.bkahlert.kommons_deprecated.text.AnsiCodeHelper.parseAnsiCodes
import com.bkahlert.kommons_deprecated.text.AnsiCodeHelper.unclosedCodes
...
import com.bkahlert.kommons_deprecated.text.AnsiString.Companion
import com.bkahlert.kommons_deprecated.text.RenderCondition.ALWAYS
import com.bkahlert.kommons_deprecated.text.RenderCondition.AUTO
...
public object ANSI {
    ...
    public class Text private constructor(text: CharSequence, formatter: FilteringFormatter<CharSequence> = FilteringFormatter.ToCharSequence) :
        ...
        override fun style(formatter: FilteringFormatter<CharSequence>): Text? = formatter(text)?.let(ANSI::Text)
...
private interface Color {
    ...
    fun toHex(
        ...
        renderAlpha: RenderCondition = AUTO,
...
private data class RGB(val r: Int, val g: Int, val b: Int, val a: Float = 1f) : Color {
    ...
    override fun toHex(withNumberSign: Boolean, renderAlpha: RenderCondition): String = buildString(9) {
        ...
        if (renderAlpha == ALWAYS || renderAlpha == AUTO && a < 1) {
