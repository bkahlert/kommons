...
import com.bkahlert.kommons_deprecated.exec.ExecTerminationTestCallback.Companion.expectThatProcessAppliesTerminationCallback
...
import com.bkahlert.kommons_deprecated.test.OldDynamicTestsWithSubjectBuilder
...
import com.bkahlert.kommons_deprecated.tracing.rendering.capturing
import com.bkahlert.kommons_deprecated.tracing.spans
...
class ExecutorTest {
    ...
    inner class Executables {
        ...
        fun `should exec using specified working directory`() {
            val exec = CommandLine("pwd").exec(com.bkahlert.kommons_deprecated.Kommons.ExecTemp)
            val tempPaths =
                setOf(com.bkahlert.kommons_deprecated.Kommons.ExecTemp.pathString, com.bkahlert.kommons_deprecated.Kommons.ExecTemp.toRealPath().pathString)
