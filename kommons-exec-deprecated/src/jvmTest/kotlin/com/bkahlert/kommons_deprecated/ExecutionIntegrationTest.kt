...
import com.bkahlert.kommons_deprecated.docker.dockerized
...
import com.bkahlert.kommons_deprecated.exec.error
...
class ExecutionIntegrationTest {
    ...
    fun `should exec using docker`(simpleId: SimpleId) = withTempDir(simpleId) {
        ...
        CommandLine("printenv", "HOME").exec() should {
            it.io.output.ansiRemoved shouldBe com.bkahlert.kommons.SystemLocations.Home.pathString
        }
