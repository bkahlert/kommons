...
import com.bkahlert.kommons_deprecated.Exceptions.ISE
import com.bkahlert.kommons_deprecated.TestKommons
import com.bkahlert.kommons_deprecated.test.DynamicTestBuilder.InCompleteExpectationBuilder
import com.bkahlert.kommons_deprecated.test.TestFlattener.flatten
import com.bkahlert.kommons_deprecated.test.Tester.assertingDisplayName
import com.bkahlert.kommons_deprecated.test.Tester.findCaller
...
object Tester {
    ...
    fun findCaller(): StackTraceElement {
        return com.bkahlert.kommons.test.KommonsTest.locateCall()
    }
}
