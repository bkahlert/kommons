...
import com.bkahlert.kommons_deprecated.exception.dump
...
import com.bkahlert.kommons_deprecated.tracing.KommonsTelemetry
 ...
 * substitution and helps to cope with concurrency (e.g.
 ...
 *
 * **This is where *Kommons Exec* jumps in.**
 ...
 *
 * ### Simplified API
 * [com.bkahlert.kommons_deprecated.exec.Process] interface for
 * 1) easier mocking and
 * 2) and a simplified API
 *
 * ### Tracing
 * If [OpenTelemetry](https://opentelemetry.io/) is detected or explicitly set using [com.bkahlert.kommons_deprecated.tracing.KommonsTelemetry.register]
