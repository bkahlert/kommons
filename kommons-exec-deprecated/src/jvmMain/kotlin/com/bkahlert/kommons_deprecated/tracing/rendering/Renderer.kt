...
public interface Renderer {
     ...
     */
    public fun childRenderer(renderer: RendererProvider = { it.create(this) }): Renderer
    ...
    public companion object {
         ...
         * If too many event names are created the value of the recorded data for later analysis is considerably reduced.
...
public fun interface RendererFactory {
    public fun create(settings: Settings): Renderer
}
