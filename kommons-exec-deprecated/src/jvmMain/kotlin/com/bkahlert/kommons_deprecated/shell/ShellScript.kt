...
import com.bkahlert.kommons_deprecated.builder.Builder
...
import com.bkahlert.kommons_deprecated.io.path.writeText
import com.bkahlert.kommons_deprecated.shell.ShellScript.ScriptContext
import com.bkahlert.kommons_deprecated.shell.ShellScript.ScriptContext.Line
import com.bkahlert.kommons_deprecated.text.Banner.banner
...
public open class ShellScript(
     ...
     */
    public fun toFile(
        path: Path = com.bkahlert.kommons_deprecated.Kommons.FilesTemp.createTempFile(this.name.toIdentifier(8), ".sh"),
    ...
    public companion object : Builder<ScriptInit, ShellScript> {
