...
import com.bkahlert.kommons_deprecated.Exceptions
import com.bkahlert.kommons_deprecated.docker.Docker.BusyBox
import com.bkahlert.kommons_deprecated.docker.Docker.CurlJq
import com.bkahlert.kommons_deprecated.docker.Docker.Ubuntu
import com.bkahlert.kommons_deprecated.docker.Docker.info.get
...
import com.bkahlert.kommons_deprecated.exec.Executable
import com.bkahlert.kommons_deprecated.exec.ProcessingMode
import com.bkahlert.kommons_deprecated.exec.Processors.processingProcessor
import com.bkahlert.kommons_deprecated.exec.RendererProviders.errorsOnly
...
import com.bkahlert.kommons_deprecated.exec.successful
import com.bkahlert.kommons_deprecated.io.path.moveTo
import com.bkahlert.kommons_deprecated.io.path.uriString
...
public object Docker {
     ...
     */
    public val engineRunning: Boolean get() = isInstalled && DockerInfoCommandLine().exec().successful
    ...
    public fun search(
        ...
        limit: Int = 100,
        renderer: RendererProvider? = errorsOnly(),
