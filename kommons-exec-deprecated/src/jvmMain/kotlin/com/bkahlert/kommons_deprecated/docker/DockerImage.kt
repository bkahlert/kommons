...
import com.bkahlert.kommons_deprecated.docker.DockerImage.Companion.parse
import com.bkahlert.kommons_deprecated.docker.DockerImage.ImageContext
...
public open class DockerImage(
    ...
    public val tagsOnDockerHub: List<String>
        get() {
            ...
            return com.bkahlert.kommons_deprecated.Kommons.ExecTemp.curlJq("hub.docker.com tags") {
