...
public object DateTimeFormatters {
    ...
    public val ISO8601_INSTANT: com.bkahlert.kommons.time.DateTimeFormatter = DateTimeFormatter(
        DateTimeFormatter.ISO_INSTANT,
        Path::class to DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH-mm-ss").withZone(ZoneOffset.UTC)
    )
    public val ISO8601_LOCAL_DATE: com.bkahlert.kommons.time.DateTimeFormatter = DateTimeFormatter(
