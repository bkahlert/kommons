 ...
 *
 * ### Simplified API
 * [com.bkahlert.kommons.exec.Process] interface for
 * 1) easier mocking and
 * 2) and a simplified API
 *
 * ### Tracing
 * If [OpenTelemetry](https://opentelemetry.io/) is detected or explicitly set using [com.bkahlert.kommons.tracing.KommonsTelemetry.register]
