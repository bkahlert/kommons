...
class ColumnsLayoutTest {
    ...
    inner class SingleColumn {
        ...
        fun `should extract matching description`() {
            expectThat(ColumnsLayout(RenderingAttributes.DESCRIPTION columns 60).extract(
        ...
        fun `should extract matching attribute`() {
            expectThat(ColumnsLayout(Key.stringKey("col1") columns 60)
    ...
    inner class MultipleColumns {
        ...
        fun `should apply gap`() {
            expectThat(ColumnsLayout(Key.stringKey("col1") columns 55,
                Key.stringKey("col2") columns 20,
                gap = 20,
                maxColumns = 80).scaled.toList()).containsExactly(
