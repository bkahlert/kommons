...
import koodies.runtime.ClassPathTest.META_INF.Services
import koodies.runtime.ClassPathTest.META_INF.Services.JUnitExtensions
import koodies.runtime.ClassPathTest.resources.a.b.c
import koodies.runtime.ClassPathTest.resources.a.b.c.file
...
class ClassPathTest {
    ...
    inner class DynamicClassPathFile {
        ...
        fun `should have data`() = testEach(dynamicClassPathFile, staticClassPathFile) {
            expecting { data.decodeToString() } that { contains("koodies.test.junit.TestNameResolver") }
    ...
    inner class CopyFile {
        ...
        fun `should copy file`(uniqueId: UniqueId) = withTempDir(uniqueId) {
            expecting { JUnitExtensions.copyTo(resolve("test.txt")) } that {
                ...
                textContent.contains("koodies.test.junit.TestNameResolver")
            }
        }
