...
class ResolveBetweenFileSystemsKtTest {
    ...
    inner class WithSameFileSystem {
        ...
        @Test
        fun `should return relative jar path resolved against jar path`() = withTempDir {
        ...
        @Test
        fun `should return relative file path resolved against file path`() = withTempDir {
    ...
    inner class WithAbsoluteOtherPath {
        ...
        @Test
        fun `should return absolute jar path resolved against jar path`() = withTempDir {
            tempJarFileSystem().use { jarFileSystem ->
        ...
        @Test
        fun `should return absolute jar path resolved against file path`() = withTempDir {
        ...
        @Test
        fun `should return absolute file path resolved against jar path`() = withTempDir {
        ...
        @Test
        fun `should return absolute file path resolved against file path`() = withTempDir {
    ...
    inner class WithRelativeOtherPath {
        ...
        @Test
        fun `should return file path on relative jar path resolved against file path`() = withTempDir {
            val receiverFilePath: Path = randomDirectory().randomFile()
            tempJarFileSystem().use { jarFileSystem ->
        ...
        @Test
        fun `should return jar path on relative file path resolved against jar path`() = withTempDir {
