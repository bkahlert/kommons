...
class DecimalPrefixTest {
    ...
    fun `should format integer decimal form`() = testEach(
        4_200_000.Yotta to "4200000000000000000000000000000.0",
        4_200.Yotta to "4200000000000000000000000000.0",
        42.Yotta to "42000000000000000000000000.0",
        42.Zetta to "42000000000000000000000.0",
        42.Exa to "42000000000000000000.0",
        42.Peta to "42000000000000000.0",
        42.Tera to "42000000000000.0",
        42.Giga to "42000000000.0",
        42.Mega to "42000000.0",
        42.kilo to "42000.0",
        42.hecto to "4200.0",
        42.deca to "420.0",
        42.deci to "4.20",
        42.centi to "0.420",
        42.milli to "0.0420",
        42.micro to "0.0000420",
        42.nano to "0.0000000420",
        42.pico to "0.0000000000420",
        42.femto to "0.0000000000000420",
        42.atto to "0.0000000000000000420",
        42.zepto to "0.0000000000000000000420",
        42.yocto to "0.0000000000000000000000420",
    ...
    fun `should format fraction decimal form`() = testEach(
        4_200_000.Giga to "4200000000000000.0",
        4_200.Giga to "4200000000000.0",
        420.Giga to "420000000000.0",
        42.Giga to "42000000000.0",
