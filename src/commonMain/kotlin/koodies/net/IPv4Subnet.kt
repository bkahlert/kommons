...
operator fun IPv4Address.div(prefixLength: Int): IPv4Subnet = IPv4Subnet.from(this, prefixLength)
val ClosedRange<IPv4Address>.smallestCommonSubnet: IPv4Subnet get() = IPv4Subnet.getSmallestCommonSubnet(this)

fun String.toIPv4Subnet(): IPv4Subnet = IPv4Subnet.parse(this)
fun ip4SubnetOf(value: String): IPv4Subnet = value.toIPv4Subnet()
