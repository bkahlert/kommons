 ...
 */
public object DefaultIPv4toIPv6Mapping : OffsetIPv4toIPv6Mapping(
    bigIntegerOf(
        ubyteArrayOf(
            UByte.OO, UByte.OO, UByte.OO, UByte.OO,
            UByte.OO, UByte.OO, UByte.OO, UByte.OO,
            UByte.OO, UByte.OO, UByte.FF, UByte.FF,
        )
 ...
 */
public object Nat64IPv4toIPv6Mapping : OffsetIPv4toIPv6Mapping(
    bigIntegerOf(
        ubyteArrayOf(
            UByte.OO, 0x64u, UByte.FF, 0x9Bu,
            UByte.OO, UByte.OO, UByte.OO, UByte.OO,
            UByte.OO, UByte.OO, UByte.OO, UByte.OO,
        )
    ) shl IPv4Address.bitCount
