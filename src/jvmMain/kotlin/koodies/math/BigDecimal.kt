 ...
 */
public actual fun BigDecimal.plus(other: BigDecimal, precision: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
 ...
 */
public actual fun BigDecimal.minus(other: BigDecimal, precision: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
 ...
 * Returns `this` `*` [other] with the provided [precision] and [roundingMode].
 */
public actual fun BigDecimal.times(other: BigDecimal, precision: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
 ...
 */
public actual operator fun BigDecimal.div(other: BigDecimal): BigDecimal = divide(other, RoundingMode.HALF_EVEN)

/**
 * Returns `this` `*` [other] with the provided [precision] and [roundingMode].
 */
public actual fun BigDecimal.div(other: BigDecimal, precision: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
 ...
 * Returns `this` `/` [other] with the provided [precision] and [roundingMode].
 */
public actual fun BigDecimal.div(other: Long, precision: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
 ...
 * Returns `this` `/` [other] with the provided [precision] and [roundingMode].
 */
public actual fun BigDecimal.div(other: Float, precision: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
    this.divide(other.toBigDecimalKotlin(), MathContext(precision, roundingMode.toJavaMathRoundMode()))
 ...
 * Returns `this` `/` [other] with the provided [precision] and [roundingMode].
 */
public actual fun BigDecimal.div(other: Double, precision: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
    this.divide(other.toBigDecimalKotlin(), MathContext(precision, roundingMode.toJavaMathRoundMode()))
 ...
 * [roundingMode] (specifies the algorithm to be used for rounding).
 */
public actual fun BigDecimal.pow(n: Int, precision: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
    this.pow(n, MathContext(precision, roundingMode.toJavaMathRoundMode()))

public actual val BigDecimal.scale: Int
    get() = this.scale()

public actual fun BigDecimal.scale(scale: Int, roundingMode: koodies.math.RoundingMode): BigDecimal =
    setScale(scale, roundingMode.toJavaMathRoundMode())

public actual val BigDecimal.precision: Int
    get() = precision()

private fun koodies.math.RoundingMode.toJavaMathRoundMode() = when (this) {
    UP -> RoundingMode.UP
