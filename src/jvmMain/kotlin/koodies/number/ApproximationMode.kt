...
public enum class ApproximationMode(public val calc: (Double, Double) -> Double) {
    ...
    public companion object {
         ...
         */
        public fun Number.ceil(resolution: Double = 1.0): Double = Ceil.calc(this.toDouble(), resolution)
         ...
         * @param resolution The resolution of this operation. `1` by default. Use `0.5` for example to round to halves.
         */
        public fun Number.floor(resolution: Double = 1.0): Double = Floor.calc(this.toDouble(), resolution)
         ...
         * @param resolution The resolution of this operation. `1` by default. Use `0.5` for example to round to halves.
         */
        public fun Number.round(resolution: Double = 1.0): Double = Round.calc(this.toDouble(), resolution)
    }
}
