...
public inline fun <reified E : Enum<E>, T> firstEnumValueOfOrNull(property: KProperty1<E, T>, filter: (T) -> Boolean): E? =
...
public inline fun <reified E : Enum<E>, T> firstEnumValueOfOrNull(property: KProperty1<E, T>, probe: T): E? =
...
public inline fun <reified E : Enum<E>, T> firstEnumValueOf(property: KProperty1<E, T>, filter: (T) -> Boolean): E =
...
public inline fun <reified E : Enum<E>, T> firstEnumValueOf(property: KProperty1<E, T>, probe: T): E =
