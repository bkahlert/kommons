...
* **Gradle** `testImplementation("com.bkahlert.kommons:kommons-test:2.4.0") { because("JUnit defaults, testAll, ...") }`
* **Gradle** `implementation("com.bkahlert.kommons:kommons-test:2.4.0") { because("JUnit defaults, testAll, ...") }` *(for MPP projects)*
