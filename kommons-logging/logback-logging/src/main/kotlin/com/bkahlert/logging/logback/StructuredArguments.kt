...
object StructuredArguments {
     ...
     */
    fun entries(map: Map<*, *>): StructuredArgument =
     ...
     * @see MapEntriesAppendingMarker
     */
    fun entries(vararg entries: Pair<*, *>): StructuredArgument =
     ...
     * @see MapEntriesAppendingMarker
     */
    fun entries(vararg entries: Map.Entry<*, *>): StructuredArgument =
     ...
     * @see entries
     */
    fun e(map: Map<*, *>): StructuredArgument =
     ...
     * @see entries
     */
    fun e(vararg entries: Pair<*, *>): StructuredArgument =
     ...
     * @see entries
     */
    fun e(vararg entries: Map.Entry<*, *>): StructuredArgument =
     ...
     */
    fun fields(obj: Any?): StructuredArgument =
     ...
     * @see fields
     */
    fun f(obj: Any?): StructuredArgument =
     ...
     */
    fun defer(structuredArgumentSupplier: () -> StructuredArgument): StructuredArgument =
     ...
     */
    fun toString(argument: Any?): String =
