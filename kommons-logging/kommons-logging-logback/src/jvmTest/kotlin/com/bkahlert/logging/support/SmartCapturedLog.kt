...
import com.bkahlert.logging.support.SmartCaptureSupport.getLine
import com.bkahlert.logging.support.SmartCaptureSupport.toJson
...
interface SmartCapturedLog : CharSequence {
    ...
    class LoggingLog : SmartCapturedLog {
        override val location: String? = LogbackConfiguration.activeLogFileName
