...
class EnumKtTest {
    ...
    @Test fun first_enum_value_of_or_null() = testAll {
        firstEnumValueOfOrNull<RoundingMode> { it.name == "HalfEven" } shouldBe HalfEven
        firstEnumValueOfOrNull(RoundingMode::name) { it == "HalfEven" } shouldBe HalfEven
        firstEnumValueOfOrNull(RoundingMode::name, "HalfEven") shouldBe HalfEven
    ...
    @Test fun first_enum_value_of() = testAll {
        firstEnumValueOf<RoundingMode> { it.name == "HalfEven" } shouldBe HalfEven
        firstEnumValueOf(RoundingMode::name) { it == "HalfEven" } shouldBe HalfEven
        firstEnumValueOf(RoundingMode::name, "HalfEven") shouldBe HalfEven
