...
class MessageDigestsKtTest {
    ...
    @Test fun md5_checksum(@TempDir tempDir: Path) = testAll {
        ...
        (tempDir / "file").apply { writeText("string") }.md5Checksum() shouldBe checksums[MD5]
    ...
    @Test fun sha1_checksum(@TempDir tempDir: Path) = testAll {
        ...
        (tempDir / "file").apply { writeText("string") }.sha1Checksum() shouldBe checksums[`SHA-1`]
    ...
    @Test fun sha256_checksum(@TempDir tempDir: Path) = testAll {
        ...
        (tempDir / "file").apply { writeText("string") }.sha256Checksum() shouldBe checksums[`SHA-256`]
